...
?>
<div class="conversation-header" ng-show="currentContact != null" ng-cloak>
    <div class="row align-items-center justify-content-sm-start h-100">
        <div class="" ng-show="!selectedMessages.length">
            <a href="{{ currentContact.url }}" ng-style="">
               <span class="conteaner-header-contact">
                    <img src="{{ currentContact.avatar }}" alt="" class="contact-avatar-user">
                    <span class="contenaer-avatar-status">
                        <span class="avatar-status-online" ng-show="{{ currentContact.online }}"></span>
                    </span>
                </span>
