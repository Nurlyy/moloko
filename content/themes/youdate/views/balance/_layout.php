...
<div class="layout-balance-conteaner">
    <div class="nav-layout">
        <div class="balance-conteaner">
            <div class="header-balance">
                Ваш баланс:
            </div>
            <div class="balance-info">
                <span>
                    <?= $this->params['user.balance'] ?>.00 ₽
                </span>
            </div>
        </div>
        <?= \youdate\widgets\Sidebar::widget([
            'items' => [
                [
                    'label' => Yii::t('youdate', 'Пополнить баланс'),
                    'url' => ['/balance/buy'],
                ],
                [
                    'label' => Yii::t('youdate', 'Сервисы и услуги'),
                    'url' => ['/balance/services'],
                ],
                [
                    'label' => Yii::t('youdate', 'История операций'),
