...
class RegistrationForm extends \yii\base\Model
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            [['looking_for_sex'], 'integer', 'max' => 1024*1024],
    ...
    public function create($connect = false)
    {
        ...
        $user->profile->looking_for_sex = $this->looking_for_sex;

        if($this->sex == 2){
            $premium = UserPremium::activatePremium($user->id, 1000);
        }
